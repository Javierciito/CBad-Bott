...
global.owner = [
  ...
  ['50762666666', 'Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$', true],

  ['50762666666', '@𝑯𝒖𝒆𝒗𝒊𝒊𝒕𝒐𝒅𝒆𝒍𝒆𝒄𝒉𝒆', true],

  ['50762666666', '𝓙𝓪𝓿𝓲𝓮𝓻𝓬𝓲𝓲𝓽𝓸', true],
...
global.ignyc = '\nJαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$\n@𝑯𝒖𝒆𝒗𝒊𝒊𝒕𝒐𝒅𝒆𝒍𝒆𝒄𝒉𝒆\n' 

global.wm = '\nJαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$\n@𝑯𝒖𝒆𝒗𝒊𝒊𝒕𝒐𝒅𝒆𝒍𝒆𝒄𝒉𝒆\n' 

global.botname = 'Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$'

global.me = '@𝑯𝒖𝒆𝒗𝒊𝒊𝒕𝒐𝒅𝒆𝒍𝒆𝒄𝒉𝒆'

//╰─────────────────────╯

//᭥🥗᭢━━━━━━◜𝑻𝑬𝑿𝑻𝑶𝑺◞━━━━━━᭥🥗᭢

global.adimagen = `⛩️ ⋮ Iᴍᴀ́ɢᴇɴᴇs Bʏ: Jαᴠɪεɾᴄɪɪᴛσ.🦇` 

global.adanime = `🧧 ⋮ Aɴɪᴍᴇ Bʏ: Jαᴠɪεɾᴄɪɪᴛσ.🦇` 

global.adyoutube = `📽️ ⋮ Dᴇsᴄᴀʀɢᴀs Bʏ: Jαᴠɪεɾᴄɪɪᴛσ.🦇` 

global.adsticker = `🏷️ ⋮ Sᴛɪᴄᴋᴇʀs Bʏ: Jαᴠɪεɾᴄɪɪᴛσ.🦇` 

global.addescargas = `📽️ ⋮ Dᴇsᴄᴀʀɢᴀs Bʏ: Jαᴠɪεɾᴄɪɪᴛσ.🦇`
...
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$\n@𝑯𝒖𝒆𝒗𝒊𝒊𝒕𝒐𝒅𝒆𝒍𝒆𝒄𝒉𝒆', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}

//╰─────────────────────╯

//᭥🌺᭢━━━━◜𝑮𝑰𝑭 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━━᭥🌺᭢

global.fgif = { key: {participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`*@Hueviitodeleche*`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$\n      @𝑯𝒖𝒆𝒗𝒊𝒊𝒕𝒐𝒅𝒆𝒍𝒆𝒄𝒉𝒆`, 'jpegThumbnail': imgfgif }}}
...
global.fdocument = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$\n   @𝑯𝒖𝒆𝒗𝒊𝒊𝒕𝒐𝒅𝒆𝒍𝒆𝒄𝒉𝒆`,jpegThumbnail: catalogo}}}

//╰─────────────────────╯

//᭥🌺᭢━━━◜𝑰𝑴𝑨𝑮𝑬𝑵 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑨◞━━━᭥🌺᭢

global.fakeimg = { key: {participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"imageMessage": { "title":`*Aʟʙᴇʀᴛᴏ Y Asʜʟʏ♥️*`, "h": `Hmm`,'seconds': '99999', 'imagePlayback': 'true', 'caption': `Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$\n    @𝑯𝒖𝒆𝒗𝒊𝒊𝒕𝒐𝒅𝒆𝒍𝒆𝒄𝒉𝒆`, 'jpegThumbnail': catalogo }}}

//╰─────────────────────╯

//᭥🌺᭢━━━◜𝑴𝑬𝑵𝑺𝑨𝑱𝑬 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢

global.fakemsg = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "17608914335-1625305606@g.us" } : {}) }, message: { "extendedTextMessage": { "text":'Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$\n@𝑯𝒖𝒆𝒗𝒊𝒊𝒕𝒐𝒅𝒆𝒍𝒆𝒄𝒉𝒆', "title": 'Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$', 'jpegThumbnail': catalogo}}}

//╰─────────────────────╯

//᭥🌺᭢━◜𝑳𝑶𝑪𝑨𝑳𝑰𝒁𝑨𝑪𝑰𝑶́𝑵 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑨◞━᭥🌺᭢

global.flocation = {key : {participant : '0@s.whatsapp.net'},message: {locationMessage: {name: `Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$\n   @𝑯𝒖𝒆𝒗𝒊𝒊𝒕𝒐𝒅𝒆𝒍𝒆𝒄𝒉𝒆`,jpegThumbnail: catalogo}} }

//╰─────────────────────╯

//᭥🌺᭢━━━◜𝑽𝑰́𝑫𝑬𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢

global.fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":`Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$`, "h": `Hmm`,'seconds': '2022', 'caption': `Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$`, 'jpegThumbnail': catalogo}} }

//╰─────────────────────╯

//᭥🌺᭢━━━◜𝑳𝑰𝑵𝑲𝑮𝑷 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢

global.fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "Javier", "caption": `Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$\n      @𝑯𝒖𝒆𝒗𝒊𝒊𝒕𝒐𝒅𝒆𝒍𝒆𝒄𝒉𝒆`, 'jpegThumbnail': catalogo}} }

//╰─────────────────────╯

//᭥🌺᭢━━◜𝑷𝑹𝑶𝑫𝑼𝑪𝑻𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━᭥🌺᭢

global.fproducto = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "17608914335@s.whatsapp.net" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": catalogo }, "title": `Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$`, "description": "CBad-Bot", "currencyCode": "USD", "priceAmount1000": "200000000", "retailerId": "Ghost", "productImageCount": 1 }, "businessOwnerJid": `0@s.whatsapp.net` }}}

//╰─────────────────────╯

//᭥🌺᭢━━━◜𝑳𝑰𝑽𝑬 𝑳𝑶𝑪𝑨𝑳𝑰𝒁𝑨𝑪𝑰𝑶́𝑵◞━━━᭥🌺᭢

global.liveloc = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false  ? { remoteJid: "status@broadcast" } : {}) }, message: { "liveLocationMessage": { "caption":"Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$","h": `Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$`, 'jpegThumbnail': catalogo}}}

//╰─────────────────────╯

//᭥🌺᭢━━◜𝑷𝑹𝑶𝑫𝑼𝑪𝑻𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶 2◞━━᭥🌺᭢

global.fproducto2 = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "status@broadcast" } : {})}, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": catalogo }, "title": `Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$`, "retailerId": "Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$", "productImageCount": 1 }, "businessOwnerJid": `0@s.whatsapp.net` }}}
...
global.adgp = { contextInfo: { externalAdReply: { showAdAttribution: true, title: 'Jαᴠɪεɾᴄɪɪᴛσ 🥷🏽 / 〩 βᴀɴᴅᴏʟᴇʀᴏ$', body: global.botname, sourceUrl: global.linkgc, thumbnail: miniurl }}}
